# -*- coding: utf-8 -*-
#
# ficus documentation build configuration file, created by
...
project = u'ficus'
copyright = u'2015, Dannis Atabay'
author = u'Dannis Atabay'
...
texinfo_documents = [
  (master_doc, 'ficus', u'ficus Documentation',
   author, 'ficus', 'One line description of project.',
   'Miscellaneous'),
]
